package com.cyrilleleclerc.otel.elastic;
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Otel Logs emitted");
        System.out.println("Sleep to wait for logs to be ingested by Elastic...");
        Thread.sleep(3_000);
        System.out.println("Retrieve logs from Elasticsearch...");
        // VERIFY LOG MESSAGES IN ELASTICSEARCH
        {
            ...
            // TODO stop OKHTTP
            System.exit(0); // force exit because OKHTTP is not properly stopped
        }
    }
}
